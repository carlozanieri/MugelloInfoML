# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in Info.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': info.model,
    'DBSession': info.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "db2995f8-4d4a-4381-b6ae-cb5e6bc09c27",
